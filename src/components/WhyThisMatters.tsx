          ...
          <div className={`inline-flex flex-col items-center gap-6 p-8 rounded-2xl backdrop-blur-xl border ${
            ...
            <button
              ...
              <button
                ...
                className="group relative px-8 py-4 bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 rounded-full text-white font-semibold text-lg overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25">
                <span className="relative z-10 flex items-center gap-2">
                  <Sparkles className="w-4 h-4" />
                  Join Waitlist
                  <motion.div
