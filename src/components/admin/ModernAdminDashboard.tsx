...
const ModernAdminDashboard: React.FC = () => {
  ...
  const renderOverviewTab = () => (
    <div className="space-y-10">
      ...
      {gaLoading && (
        <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-800/50">
          <div className="text-center">
            ...
            <div className="text-green-400">Loading Google Analytics...</div>
          </div>
        </div>
      )}
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-800/50 hover:border-gray-700/50 transition-all duration-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-white mt-2">{(gaData.pageViews || 0).toLocaleString()}</p>
                </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-800/50 hover:border-gray-700/50 transition-all duration-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-white mt-2">{(gaData.uniqueVisitors || 0).toLocaleString()}</p>
                </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-800/50 hover:border-gray-700/50 transition-all duration-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-white mt-2">{gaData.bounceRate || 0}%</p>
                </div>
            ...
            <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-800/50 hover:border-gray-700/50 transition-all duration-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-white mt-2">{gaData.avgSessionDuration || 0}s</p>
                </div>
          ...
          <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-800/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              {/* GA Error State */}
        {!gaLoading && gaError && (
          <div className="bg-red-900/20 backdrop-blur-xl rounded-2xl p-6 border border-red-800/50">
            <div className="text-center">
              <div className="text-red-400 text-lg mb-2">⚠️ Google Analytics Error</div>
              <div className="text-gray-400 text-sm mb-4">{gaError}</div>
              <div className="flex items-center justify-center space-x-4">
                {gaError.includes('authentication') && (
                  <button
                    onClick={async () => {
                      try {
                        setGaError(null);
                        ...
                        setGaError('Authentication failed. Please try again.');
                      }
                    }}
      ...
      {!gaLoading && !gaError && !isGAConnected && (
        <div className="bg-blue-900/20 backdrop-blur-xl rounded-2xl p-6 border border-blue-800/50">
          <div className="text-center">
            ...
            <div className="text-gray-400 text-sm mb-4">
              Connect your Google Analytics 4 property to see real-time website analytics data.
              <br />
              Your GA configuration is properly set up and ready to use.
            </div>
            <div className="flex items-center justify-center space-x-4">
              <button
                onClick={async () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <div className={`w-2 h-2 rounded-full ${
                  systemStatus.database === 'online' ? 'bg-green-400' : 'bg-yellow-400'
                } animate-pulse`}></div>
      ...
      {/* Main Content */}
      <main className={`transition-all duration-300 py-12 ${
        sidebarCollapsed ? 'w-full px-6 sm:px-8 lg:px-12' : 'w-full px-6 sm:px-8 lg:px-12'
      }`}>
        {/* Tab Navigation */}
        <div className="mb-10">
          <nav className="flex space-x-2 bg-gray-900/50 backdrop-blur-xl rounded-2xl p-3 border border-gray-800/50">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              return (
                <button
...
const StatCard: React.FC<{
  ...
  <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-8 border border-gray-800/50 hover:border-gray-700/50 transition-all duration-200 group">
    <div className="flex items-center justify-between">
      <div>
        <p className="text-gray-400 text-base font-medium">{title}</p>
        <p className="text-4xl font-bold text-white mt-3">{value.toLocaleString()}</p>
      </div>
      <div className={`w-16 h-16 bg-gradient-to-r ${color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-200`}>
        <Icon className="w-8 h-8 text-white" />
      </div>
    </div>
    <div className="mt-6 flex items-center">
      <span className={`text-base font-medium ${trendUp ? 'text-green-400' : 'text-red-400'}`}>
        {trend}
      </span>
      <span className="text-gray-400 text-sm ml-2">from last month</span>
    </div>
